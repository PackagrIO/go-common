...
// CreateTagAtReference mocks base method.
func (m *MockInterface) CreateTagAtReference(tagName string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateTagAtReference", tagName)
	ret0, _ := ret[0].(error)
	return ret0
}

// CreateTagAtReference indicates an expected call of CreateTagAtReference.
func (mr *MockInterfaceMockRecorder) CreateTagAtReference(tagName interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateTagAtReference", reflect.TypeOf((*MockInterface)(nil).CreateTagAtReference), tagName)
}
